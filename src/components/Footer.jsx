  ...
  return (
    <div className="footer py-5">
      <Container>
        <Row className="d-flex justify-content-between">
          <Col lg="5">
            ...
            <p className="desc">
              ...
              incidunt neque repudiandae repellat tenetur voluptatum reiciendis
              soluta distinctio veritatis ipsa!
            </p>
            <div className="no mb-1 mt-4">
              <Link className="text-decoration-none">
                <i className="fa-brands fa-whatsapp"></i>
                <p className="m-0">+62 123-4567</p>
              </Link>
            </div>
            <div className="mail">
              <Link className="text-decoration-none">
          ...
          <Col lg="4" className="mt-lg-0 mt-5">
            <h5 className="fw-bold mb-3">Subcribe unutuk info menarik</h5>
        ...
        <Row>
          <Col>
            <p className="text-center px-md-5 px-3 ">
